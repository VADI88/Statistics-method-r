...
Why we required non-parametric mthods :

-   Do not assume any specific distributions

-   Useful when data doesnt meet any assumptions - like Normality

-   More robust towards outliers and skewed data

-   Applicable to ordinal data and

Disadvantages:

-   Less powerful than parametrics test if data meet assumptions

-   No parameter estimates limiting interpret-ability

-   Less precise due to use of risk

-   More computation power

#### Wilcox Signed-Rank Test

-   compare two related samples or matched pairs

-   Tests for difference in the rank of paired observations

-   Similar to T-test

-   Suitable to ordinal or non-normal distributed data
...
-   Test for different in group distributions
...
-   Similar to Mann-Whitney U_test but more two groups

-   Test difference in group distributions using ranks

-   Similar to ANOVA

-   Suitable for ordinal or non-normally distributed continous

####  Spearman’s Rank Correlation

-   Similar to Pearson's correlations

-   Measure the strength and direction of association between two ranked variables

-   Suitable for ordinal or continous

#### Kernel Smoothing Regression

-   Estimates the relationship between variables.

-   Smooths the data points to provide a flexible fit.

-   Useful for exploring data patterns and trends.

-   Can handle non-linear relationships.

-   Alternative to parametric methods such as linear and polynomial regression.

\
Bootstrap Resampling

Estimates the sampling distribution of a point estimate by
resampling with replacement.
Does not rely on assumptions about the data distribution.
Useful for estimating confidence intervals for a point estimate.
Applicable to small sample sizes and complex data structures.
