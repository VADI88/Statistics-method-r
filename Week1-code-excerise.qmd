...
-   Calculate the mean of the Temp column in the `airquality` data set.
...
-   Calculate the variance of the Wind column.
    What is the variance?

-   Calculate the standard deviation of the Wind column.
    What is the result?\
